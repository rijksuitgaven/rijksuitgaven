-- =====================================================
-- Expand instrumenten_aggregated with more columns
-- Description: Adds begrotingsnaam, instrument for faster column queries
-- Created: 2026-01-31
-- Executed: 2026-01-31 on production (Supabase)
-- =====================================================
--
-- Problem: Requesting columns not in the view caused 3.5s query (fell back to source table)
-- Solution: Added commonly requested columns to the materialized view
-- Result: Query time reduced from 3500ms to ~500ms (7x improvement)
-- =====================================================
