...
|-----------|-------------|
| Embedding model | OpenAI, Cohere, or multilingual-e5 (open source) |
...
2. Which embedding model works best for Dutch organization names?
