...
- ✅ **2026-02-18 (Session 4):** UX-035 Datasets page built and deployed. BFF route `GET /api/v1/datasets` (auth-gated Supabase query). Page renders 6 sections: 3 simple (year range text) + 3 matrix (entity × year checkmarks). Footer "Datasets" link added. Source links removed per user feedback. 2 commits.
