...
| V5.0 Lab prototype (h6) | ✅ Built (Feb 24-25) | 21 interactive viz concepts across 7 analytical domains: Pulse, New Money, Movers, Ministry DNA, Treemap, Dependency Radar, Concentration Index, Anomaly Detector, Money Flow, Share Shift, Sunburst, Growth Comparator, Spending Velocity, Pattern Deviation, Spending Spectrum, Reverse Flow, Ministry Cost Structure, Per Capita, Regeling Profile, Leaderboard, Head-to-Head. Recharts+D3+SVG. Design doc at `docs/plans/2026-02-25-v5-comprehensive-design.md` |
...
1. **V5.0 Inzichten — Full 21-Concept Visualization Suite** (2026-02-25)
   Designed comprehensive 7-domain framework (Composition, Trend, Variance, Outlier, Flow, Efficiency, Ranking). Built 12 new concepts (10-21) on top of 9 existing: Share Shift, Sunburst, Growth Comparator, Spending Velocity, Pattern Deviation, Spending Spectrum, Reverse Flow, Ministry Cost Structure, Per Capita, Regeling Profile, Leaderboard, Head-to-Head. 12 BFF routes + 12 frontend components. Comprehensive design doc. Pushed to both environments.
