...
| `app/src/components/data-table/data-table.tsx` | Removed ghost column, collapse chevron on first year, Totaal sticky right + shadow |
| `app/src/components/data-table/expanded-row.tsx` | Same ghost column fix, colSpan adjustments |
