...
| `docs/plans/2026-02-06-data-availability-indicators-design.md` | Design doc for "no data" vs "zero" indicators |
...
| `d21f1dc` | Docs: Complete daily log for 2026-02-06 |
| `5f6ba1c` | Design: Data availability indicators (no-data vs zero) |
| `ac9e13e` | Docs: Add UX-011, Data Availability to backlog, audit fixes |
...
3. **Footer Integration with Auth**
