...
- [ ] Invite email for new members (backlog item — replace createUser with inviteUserByEmail)
- [ ] Set up "Invite User" email template in Supabase (Dutch)
- [ ] Import ~50 WordPress users to Supabase (CSV import + subscription rows)
