...
| `app/src/components/data-table/data-table.tsx` | NoDataCell, availability checks, removed * footer, totals row em-dash, click ontvanger expands row, staffelbedrag popover |
