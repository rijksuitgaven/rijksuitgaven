...
**Commits:** 20 (6 session 1 + 2 docs + 1 session 2 + 1 session 3 + 1 docs + 1 session 4 + 1 docs + 1 session 5 + 1 docs + 3 session 6 + 1 session 7 + 1 session 8 + pending session 9)
