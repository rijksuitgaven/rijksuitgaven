...
### 25. Semantic Search Brainstorm (Session 10)

Brainstormed semantic search improvements to filter false positives.
...
|---------|----------|--------|
| V1.1 | Dutch word rules (-ie/-iek exclusion) | Planned |
| V2.0 | Embeddings (vector similarity search) | Planned |

**Embeddings Overview:**
- Convert text to vectors capturing meaning
- "Politie" and "Nationale Politie" → similar vectors
- "Politie" and "Politieke Partij" → different vectors
- Uses pgvector (already enabled in Supabase)
- Cost: ~€5-10 one-time, €1-5/month

**Decision:** Keep current search for V1.0, implement rules in V1.1, embeddings in V2.0.
