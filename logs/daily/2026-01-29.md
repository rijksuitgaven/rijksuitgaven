...
| `inkoop_aggregated` | leverancier | Pending |
| `provincie_aggregated` | ontvanger | Pending |
| `gemeente_aggregated` | ontvanger | Pending |
| `publiek_aggregated` | ontvanger | Pending |
...
1. **Complete entity resolution** - Run remaining views (inkoop, provincie, gemeente, publiek)
2. **Week 6 - User Auth** - Continue with Magic Link authentication setup
3. **User migration** - Import 50 existing users from WordPress
4. **Overzicht page** - Module totals overview page
5. **Beta testing** - Prepare for 5-user beta test
