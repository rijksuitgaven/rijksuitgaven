...
| `app/src/app/team/mail/page.tsx` | Media tab, media library state/fetch, draft image restoration, upload zone text, test button, precheck, device preview, sequences tab, topic selector |
...
| (campaign commit hash unknown) | Campaign features: 6 phases, 13 features, 6 migrations |
...
- [ ] Run migrations 066-071 on Supabase (DONE - executed in session)
- [ ] Deploy Railway cron service for sequences (guided, pending user deploy)
